package net.mcreator.chrissmod;
...
@Mod("chriss_mod")
public class ChrissModMod {
	public static final Logger LOGGER = LogManager.getLogger(ChrissModMod.class);
	public static final String MODID = "chriss_mod";
